Feature: Zadanie2
  ...
  Scenario Outline: Order a sweater
    ...
    And he adds "<quantity>" pieces of "<size>" size to cart
...
#    And he confirms payment
    ...
    Examples:
      | login              | password        |alias   |address  |company          |city     |phone       |postcode       |size|quantity|
      | danken00@yahoo.com | 28FKGPsSGkdzwFU |Daniel  |Boczna 3 |Q-LOC S.A.       |Warszawa |+48515531078|42-420         |M   |5       |
      | danken00@wp.pl     | yoloyolo10      |Adam    |Ottona 6 |Adamex sp. z o.o.|Londyn   |+48666121321|45-666         |M   |5       |
